...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="{{ route('home') }}">
            <x-secondaryLogo class="w-auto h-16 mx-auto text-indigo-600" />
        </a>

        <h2 class="mt-6 text-3xl font-extrabold text-center text-gray-900 leading-9">
            Reset password
        </h2>
    <a href="{{('/login')}}" class="flex justify-center" title="Back to login">
            <x-backArrow class="w-auto h-16 mx-auto" />
        </a>
    </div>
