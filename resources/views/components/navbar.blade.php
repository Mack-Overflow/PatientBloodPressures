            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-6 pt-2">
                        <a href="{{ route('home') }}"
                            class="bg-blue-700 hover:bg-blue-800 text-gray-100 px-3 py-2 rounded-md text-sm font-medium"
                            aria-current="page">Home</a>

                        <a href="{{ route('patients.index') }}"
                            class="bg-blue-700 my-auto text-white hover:bg-blue-800 hover:gray-100 px-3 py-2 rounded-md text-sm font-medium">Patients</a>
